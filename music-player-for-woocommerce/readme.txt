...
* Improved the plugin's security by implementing the recommendations from the WordPress automated security review.
...
* Improves the Elementor integration module.
...
* Updates the .htaccess file within the wcmp directory to resolve conflicts caused by certain server configurations.
...
* Ensure compatibility with the latest WooCommerce update.

= 1.7.1 =

* Updated the player-loading module to ensure compatibility with a wider range of website builders and themes.

= 1.7.0 =

* The plugin update introduces a new Skin Generator module that leverages AI to create fully personalized player skins.
...
* Purges the Elementor cache during the plugin settings update.

= 1.6.1 =

* Fixes an issue with the Show a single player option in the products settings.
